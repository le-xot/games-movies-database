    ...
    <div class="space-y-4">
      <FormField v-slot="{ componentField }" name="link">
        <FormItem>
          ...
          <Input v-bind="componentField" :placeholder="placeholder || 'https://example.com/'" />
          <FormMessage />
        </FormItem>
      </FormField>
      ...
      <div
        v-if="errorMessage"
        class="flex items-center gap-2 text-red-500 text-sm p-2 bg-red-50 rounded-md"
      >
      ...
      <div class="flex justify-end space-x-3">
        <Button type="button" variant="secondary" @click="handleCancel"> Отмена </Button>
