...
<template>
  <SelectItem
    ...
    :class="
      cn(
        'relative flex w-full cursor-default select-none items-center rounded-sm p-0.5 text-sm outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
        props.class,
        {
